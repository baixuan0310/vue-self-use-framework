...
import { createDesigner } from "@vFrom/components/form-designer/designer";
import {
...
import { MOCK_CASE_URL, VARIANT_FORM_VERSION } from "@vFrom/utils/config";
import i18n, { changeLocale } from "@vFrom/utils/i18n";
