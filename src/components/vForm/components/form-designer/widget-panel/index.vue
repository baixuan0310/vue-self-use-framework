                ...
                >
                  <span>
                    <svg-icon
                      :icon-class="fld.icon"
                      class-name="color-svg-icon"
                    />{{ `${fld.name ? fld.name : fld.type}` }}</span
                  >
                </li>
              </draggable>
            </el-collapse-item>
...
import { addWindowResizeHandler } from "@vFrom/utils/util";
import i18n from "@vFrom/utils/i18n";
import axios from "axios";
import SvgIcon from "@vFrom/components/svg-icon";

// import ftImg1 from '@vFrom/assets/ft-images/t1.png'
// import ftImg2 from '@vFrom/assets/ft-images/t2.png'
// import ftImg3 from '@vFrom/assets/ft-images/t3.png'
// import ftImg4 from '@vFrom/assets/ft-images/t4.png'
// import ftImg5 from '@vFrom/assets/ft-images/t5.png'
// import ftImg6 from '@vFrom/assets/ft-images/t6.png'
// import ftImg7 from '@vFrom/assets/ft-images/t7.png'
// import ftImg8 from '@vFrom/assets/ft-images/t8.png'
  ...
  methods: {
    ...
    loadFormTemplate(jsonUrl) {
      this.$confirm(
        ...
        .then(() => {
          console.log(jsonUrl);
          if (String(jsonUrl).includes("http")) {
            axios
              .get(jsonUrl)
              .then((res) => {
              ...
              .catch((error) => {
                this.$message.error(
                  this.i18nt("designer.hint.loadFormTemplateFailed") +
                    ":" +
                    error
                );
              });
            ...
            let modifiedFlag = false;
            console.log(jsonUrl.default);
            modifiedFlag = this.designer.loadFormJson(jsonUrl.default);
            if (modifiedFlag) {
              this.designer.emitHistoryChange();
            }
            this.$message.success(
