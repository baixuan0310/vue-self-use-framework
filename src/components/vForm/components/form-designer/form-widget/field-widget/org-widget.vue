...
<script>
// import { getArchitectureOption } from "@vFrom/api/common.js";
// import OrgPannel from "@vFrom/components/org-modal/index";
...
export default {
  ...
  methods: {
    ...
    getMember() {
      // getArchitectureOption({ type: 1 }).then((res) => {
      //   if (res.code == 200) {
      //     this.data = [res.data];
      //   }
      // });
    ...
    confirm() {
      ...
      console.log(this.selectNames, 999);
