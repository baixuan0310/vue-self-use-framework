<template>
  ...
  >
    <el-input
      ...
      :style="{
        '--inputBgColor': field.options.backColor,
        '--inputAlign': field.options.textAlign,
        '--inputBorder': field.options.borderColor,
        '--inputWeight': field.options.isBold,
        '--inputColor': field.options.textColor,
        '--inputHeight': field.options.height,
        '--inputWidth': field.options.width,
      }"
    >
      <el-button
        slot="append"
...
export default {
  ...
  data() {
    return {
      ...
      fieldModel: null,
      rules: [],
      colorVal: this.field.options.backColor,
    };
  },
  computed: {
    inputType() {
