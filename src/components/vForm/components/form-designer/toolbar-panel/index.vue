    ...
    <div class="right-toolbar" :style="{ width: toolbarWidth + 'px' }">
      <div class="right-toolbar-con">
        ...
        <el-button type="text" @click="save">
          <svg-icon icon-class="vue-sfc" />保存</el-button
        >
...
<script>
import VFormRender from "@vFrom/components/form-render/index";
import CodeEditor from "@vFrom/components/code-editor/index";
...
} from "@vFrom/utils/util";
import i18n from "@vFrom/utils/i18n";
import { generateCode } from "@vFrom/utils/code-generator";
import { genSFC } from "@vFrom/utils/sfc-generator";
import loadBeautifier from "@vFrom/utils/beautifierLoader";
import { saveAs } from "file-saver";
import SvgIcon from "@vFrom/components/svg-icon";
...
export default {
  ...
  mounted() {
    ...
    //设置默认值
    // window.localStorage.setItem('widget__list__backup', JSON.stringify([{ "type": "file-text", "icon": "static-text", "formItemFlag": false, "options": { "name": "filetext62987", "columnWidth": "200px", "textContent": "文本", "fontSize": "18px", "textAlign": "center", "customClass": [], "onCreated": "", "onMounted": "", "textColor": "#000", "width": "100%", "height": "24px", "isBold": "normal", "fontFamily": "FangSong", "label": "file-text" }, "id": "filetext62987" }]))
  },
  methods: {
    ...
    previewForm() {
      ...
      console.log(this.testOptionData, this.testFormData, this.formJson);
    },
    ...
    save() {
      ...
      // [{"type":"file-text","icon":"static-text","formItemFlag":false,"options":{"name":"filetext62987","columnWidth":"200px","textContent":"文本","fontSize":"18px","textAlign":"center","customClass":[],"onCreated":"","onMounted":"","textColor":"#000","width":"100%","height":"24px","isBold":"normal","fontFamily":"FangSong","label":"file-text"},"id":"filetext62987"}]
    },
    copyVueCode(e) {
      copyToClipboard(
        this.vueCode,
